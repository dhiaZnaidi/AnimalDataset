def extract_information_from_txt_ALOV(file_name,file_out):
  """
  ...
  with open(file_out,'w') as f_out :
    ...
    for i in range(0,len(list_of_contents),5):
        k = list_of_contents[i].split(',')
...
for animal in ["Cheetah","Cygne","Jellyfish","Lions","SeaTurtle","Butterfly","Bird","Bear"]:
    extract_information_from_txt_ALOV(cwd+"/"+animal+"/coords_"+animal+".txt",cwd+"/ALOV_annotations/"+animal+".ann") 